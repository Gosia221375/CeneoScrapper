...
2) Extraction of elements for a single opinion to one ccomplex variable (dictionary)
...
5) Code refactoring and optimization
    ...
    b) Creation of dictionary that describes opinions'structure with selectors for particular opinions' elements